...
async function processPdf() {
    ...
    try {
        ...
        const result = await PdfProcessingService.processPdf(file.value, 'compress', {
        ...
        if (result.success) {
            ...
            errorMessage.value = result.message || 'حدث خطأ أثناء ضغط الملف. يرجى المحاولة مرة أخرى.';
        }
    } catch (error) {
        console.error('Error compressing PDF:', error);
        errorMessage.value = 'حدث خطأ أثناء ضغط الملف. يرجى المحاولة مرة أخرى.';
    } finally {
